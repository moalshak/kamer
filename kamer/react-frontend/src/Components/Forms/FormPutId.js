...
/**
 * This form gets all the information necessary information to update a property depending on their id
 * @param onGet the function in charge of making these changes
...
const FormPutId = ({onGet}) => {
    ...
    /**
     * This function listens to the click of the button and calls the update of a property
